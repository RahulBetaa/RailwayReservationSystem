...
//					TrainBooking bookingInWaiting = new TrainBooking();
//					bookingInWaiting.setScheduleTrainId(existingTrainBooking.getScheduleTrainId())
//							.setTrainId(existingTrainBooking.getTrainId()).userId(bookingRequest.getUserId())
//							.setBookingId(bookingId).bookingTime(bookingTime).status(BookingStatus.WAITING.value())
//							.build();
//					this.trainBookingService.bookTrain(bookingInWaiting);
				}
